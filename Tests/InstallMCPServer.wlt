...
VerificationTest[
    ...
    22,
    SameTest -> Equal,
    TestID   -> "SupportedMCPClients-Has22Clients@@Tests/InstallMCPServer.wlt:3839,1-3844,2"
]

VerificationTest[
    Keys @ $SupportedMCPClients,
    { "AmazonQ", "Antigravity", "AugmentCode", "AugmentCodeIDE", "ClaudeCode", "ClaudeDesktop", "Cline", "Codex", "Continue", "CopilotCLI", "Cursor", "GeminiCLI", "Goose", "Junie", "Kiro", "LMStudio", "MimoCode", "OpenCode", "QwenCode", "VisualStudioCode", "Windsurf", "Zed" },
    SameTest -> Equal,
